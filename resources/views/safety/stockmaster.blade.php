...
@section('page-header')
    <h1>Safety
        <small><i class="ace-icon fa fa-angle-double-right"></i>&nbsp;&nbsp;&nbsp;Shoe Stock</small>
    </h1>
@endsection
...
@section('main-content')
    <div class="widget-box hidden-480">
            <div class="widget-header">
                <h4 class="widget-title">Add Shoes</h4>
                ...
                <div class="widget-main">
                    <form class="form-inline">
                        <span class="input-icon">
                            <input id="brand" placeholder="Brand Name" type="text">
                            <i class="ace-icon fa fa-key blue"></i>
                        </span>
                        <span class="input-icon">
                            <input id="size" placeholder="Shoe Size" type="text">
                        ...
                        <button type="button" id="add_shoes" class="btn btn-info btn-sm">
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr data-id="{{$each_item->id}}" >
                        <td data-type="brand_edit" class="input-edit">{{$each_item->brand}}</td>
                        <td data-type="size_edit" class="input-edit">{{$each_item->size}}</td>
...
<div id="confirm_delete_modal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Confirm Delete Shoe Entry?</h4>
      </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Update Shoe Stock</h4>
      </div>
...
@section('js-files')
    ...
    <script src="{{ asset('safety/safety_shoes.js') }}" defer></script>
