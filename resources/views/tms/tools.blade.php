...
@section('page-header')
    <h1>Tool Management
        <small><i class="ace-icon fa fa-angle-double-right"></i>&nbsp;&nbsp;&nbsp;Tools</small>
    </h1>
@endsection
...
@section('main-content')
    <div class="widget-box hidden-480">
            <div class="widget-header">
                <h4 class="widget-title">Add Tools</h4>
                ...
                <div class="widget-main">
                    <form class="form-inline">
                        <span class="input-icon">
                            <input id="code" placeholder="Tool Code" type="text">
                            <i class="ace-icon fa fa-key blue"></i>
                        </span>
                        <span class="input-icon">
                            <input id="name" placeholder="Tool Name" type="text">
                        ...
                        <span class="input-icon">
                            <input id="location" placeholder="Tool Location" type="text">
                        ...
                        <br>
                        *Tool Location is an Optional Field.
                    </form>
                </div>
            </div>
    </div>
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="hidden-480">Tool Location</th>
                        <th class="hidden-480">
                ...
                <tbody>
                    ...
                    <tr data-id="{{$each_item->id}}" >
                        <td data-type="code_edit" class="input-edit">{{$each_item->tool_code}}</td>
                        ...
                        <td data-type="threshold_edit" class="input-edit hidden-480">{{$each_item->tool_limit}}</td>
                        <td data-type="location_edit" class="input-edit hidden-480">@if($each_item->tool_location){{$each_item->tool_location}}@else - @endif</td>
...
@section('js-files')
    ...
    <script src="{{ asset('tms/tools.js') }}" defer></script>
